    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          <Img
            src={`${process.env.NEXT_PUBLIC_SERVER_URL}/cat-email-sent.png`}
            width="150"
            height="150"
            alt="DigitalEcommerce"
            style={logo}
          />
          <Text style={paragraph}>Hi there,</Text>
          <Text style={paragraph}>
            Welcome to DigitalEcommerce, the marketplace for high quality digital
